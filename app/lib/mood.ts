...
export const getMoodById = (moodId: string | undefined | null) => {
...
export const getMoodTrend = (averageScore: number) => {
  ...
  if (averageScore >= 2) return "Things have been a bit tough";
  return "You've been having a hard time lately";
};
